...
export const KNOWLEDGE_BASE = [
  { id: 'aes-256-gcm', algorithm: 'AES-256-GCM', primaryUse: 'Authenticated encryption', securityStatus: 'RECOMMENDED', pqcStatus: 'Strong symmetric margin', automotiveRelevance: 'ECU data protection / communications', reference: 'NIST FIPS 197 / SP 800-38D', strength: 'High', details: 'Authenticated encryption with associated data (AEAD). Symmetric ciphers retain a strong security margin against quantum attacks; a 256-bit key provides an ample buffer against Grover-type speedups.' },
  { id: 'aes-cmac-128', algorithm: 'AES-CMAC-128', primaryUse: 'Message authentication (SecOC)', securityStatus: 'RECOMMENDED', pqcStatus: 'Strong symmetric margin', automotiveRelevance: 'CAN / SecOC message authentication', reference: 'NIST SP 800-38B', strength: 'High', details: 'CMAC provides efficient message authentication on constrained ECUs and is widely used in AUTOSAR SecOC for in-vehicle network authentication with a freshness counter.' },
  { id: 'ecdsa-p256', algorithm: 'ECDSA P-256', primaryUse: 'Digital signatures', securityStatus: 'MIGRATION PLANNED', pqcStatus: 'Not quantum-resistant', automotiveRelevance: 'Firmware / OTA / V2X signing', reference: 'NIST FIPS 186-5', strength: 'High (classical)', details: 'Mature, well-supported signature scheme suitable for current automotive signing. It is not post-quantum resistant, so long-lifecycle programs should plan a hybrid or PQC migration path.' },
  { id: 'ecdh-p256', algorithm: 'ECDH P-256', primaryUse: 'Key exchange', securityStatus: 'MIGRATION PLANNED', pqcStatus: 'Not quantum-resistant', automotiveRelevance: 'Session key establishment', reference: 'NIST SP 800-56A', strength: 'High (classical)', details: 'Elliptic-curve Diffie-Hellman for establishing shared secrets. Vulnerable to future quantum attacks; pair with ML-KEM in a hybrid construction for long-lived systems.' },
  { id: 'sha-256', algorithm: 'SHA-256', primaryUse: 'Hashing / integrity', securityStatus: 'RECOMMENDED', pqcStatus: 'Strong margin', automotiveRelevance: 'Firmware & data integrity', reference: 'NIST FIPS 180-4', strength: 'High', details: 'General-purpose cryptographic hash with a strong security margin. Suitable for firmware integrity, HMAC, and signature message digests.' },
  { id: 'sha-384', algorithm: 'SHA-384', primaryUse: 'Hashing / integrity', securityStatus: 'RECOMMENDED', pqcStatus: 'Strong margin', automotiveRelevance: 'High-assurance integrity', reference: 'NIST FIPS 180-4', strength: 'High', details: 'Larger digest size providing extra margin for high-assurance or critical systems where a longer security horizon is required.' },
  { id: 'sha-512', algorithm: 'SHA-512', primaryUse: 'Hashing / integrity', securityStatus: 'RECOMMENDED', pqcStatus: 'Strong margin', automotiveRelevance: 'High-performance 64-bit ECUs', reference: 'NIST FIPS 180-4', strength: 'High', details: 'Efficient on 64-bit platforms; strong margin for central-compute nodes and high-assurance integrity checks.' },
  { id: 'ml-kem-768', algorithm: 'ML-KEM-768', primaryUse: 'Post-quantum key exchange', securityStatus: 'PQC STANDARD', pqcStatus: 'Quantum-resistant', automotiveRelevance: 'Future key establishment', reference: 'NIST FIPS 203', strength: 'High (PQC)', details: 'Module-lattice key encapsulation mechanism standardized by NIST. Recommended in a hybrid construction with ECDH during transition for long-lifecycle vehicles.' },
  { id: 'ml-dsa-65', algorithm: 'ML-DSA-65', primaryUse: 'Post-quantum signatures', securityStatus: 'PQC STANDARD', pqcStatus: 'Quantum-resistant', automotiveRelevance: 'Future firmware / OTA signing', reference: 'NIST FIPS 204', strength: 'High (PQC)', details: 'Module-lattice digital signature algorithm. Larger keys and signatures than ECDSA; evaluate flash and verification cost on target ECUs before adoption.' },
  { id: 'hmac', algorithm: 'HMAC', primaryUse: 'Keyed message authentication', securityStatus: 'RECOMMENDED', pqcStatus: 'Strong margin', automotiveRelevance: 'Integrity with shared keys', reference: 'NIST FIPS 198-1', strength: 'High', details: 'Hash-based message authentication code. Strong quantum margin when paired with SHA-256/384 and adequate key length.' },
  { id: 'trng', algorithm: 'TRNG', primaryUse: 'Entropy source', securityStatus: 'RECOMMENDED', pqcStatus: 'N/A', automotiveRelevance: 'Seeding key generation', reference: 'NIST SP 800-90B', strength: 'Depends on source', details: 'Hardware true random number generator used to seed a DRBG. Validate the entropy source per SP 800-90B before relying on it for key generation.' },
  { id: 'drbg', algorithm: 'DRBG', primaryUse: 'Deterministic RNG', securityStatus: 'RECOMMENDED', pqcStatus: 'N/A', automotiveRelevance: 'Cryptographic randomness', reference: 'NIST SP 800-90A', strength: 'High', details: 'Deterministic random bit generator (e.g. CTR_DRBG) seeded from a validated TRNG. The standard approach for cryptographic randomness on ECUs.' },
]
